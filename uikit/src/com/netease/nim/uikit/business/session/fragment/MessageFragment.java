...
import com.netease.nim.Constant;
...
public class MessageFragment extends TFragment implements ModuleProxy {
    ...
    private boolean isSendShareFileMessage = false;
    ...
    private void sendShareFileMessage() {
        if (isSendShareFileMessage) {
            return;
        }
        Bundle arguments = getArguments();
        Uri uri = arguments.getParcelable(Constant.EXTRA_SHARE_FILE);
        if (uri == null) {
            return;
        }
        ...
        IMMessage message = MessageBuilder.createFileMessage(sessionId, sessionType, file, file.getName());
        sendMessage(message);
        isSendShareFileMessage = true;
    }
