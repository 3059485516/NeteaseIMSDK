...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    public static void start(Context context, String contactId, SessionCustomization customization, IMMessage anchor, Uri data) {
    ...
    protected MessageFragment fragment() {
        ...
        arguments.putParcelable(Constant.EXTRA_SHARE_FILE,getIntentData());
