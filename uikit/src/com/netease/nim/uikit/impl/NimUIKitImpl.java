...
public final class NimUIKitImpl {
     ...
     * 新增
     */
    public static void startP2PSession(Context context, String account, IMMessage anchor, Uri data) {
        NimUIKitImpl.startChatting(context, account, SessionTypeEnum.P2P, commonP2PSessionCustomization, anchor, data);
    }
    ...
    public static void startTeamSession(Context context, String tid, IMMessage anchor, Uri data) {
        NimUIKitImpl.startChatting(context, tid, SessionTypeEnum.Team, commonTeamSessionCustomization, anchor, data);
    }
     ...
     */
    public static void startChatting(Context context, String id, SessionTypeEnum sessionType, SessionCustomization
            customization, IMMessage anchor, Uri data) {
        if (sessionType == SessionTypeEnum.P2P) {
            P2PMessageActivity.start(context, id, customization, anchor, data);
        } else if (sessionType == SessionTypeEnum.Team) {
            TeamMessageActivity.start(context, id, customization, null, anchor, data);
        }
    }
