...
package com.netease.nim.yl.common.ui.viewpager;
...
import com.netease.nim.yl.main.reminder.ReminderSettings;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private int indicatorColor = 0xFF41BBC8;
    ...
    private void addTabView(final int position, String title) {
        ...
        if (titleTV != null) {
            int displayHeight = (int) (ScreenUtil.getDisplayHeight() * 1.0f / 1334 * 28);
            titleTV.setTextSize(TypedValue.COMPLEX_UNIT_PX, displayHeight);
