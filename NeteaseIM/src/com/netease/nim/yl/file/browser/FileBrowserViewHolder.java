package com.netease.nim.yl.file.browser;
...
import com.netease.nim.yl.file.browser.FileBrowserAdapter.FileManagerItem;
...
public class FileBrowserViewHolder extends TViewHolder{
    ...
    protected void inflate() {
        directoryBitmap = BitmapFactory.decodeResource(NetIMCache.getContext().getResources(),R.drawable.directory);
        fileBitmap = BitmapFactory.decodeResource(NetIMCache.getContext().getResources(), R.drawable.file);
