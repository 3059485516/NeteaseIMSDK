...
public class UserProfileEditItemActivity extends UI implements View.OnClickListener {
    ...
    private void setTitles() {
        switch (key) {
            ...
            case UserConstant.KEY_PHONE:
                mTvTitle.setText(R.string.phone_number);
                editText.setInputType(InputType.TYPE_CLASS_NUMBER);
                break;
            case UserConstant.KEY_EMAIL:
                mTvTitle.setText(R.string.email);
                break;
            case UserConstant.KEY_SIGNATURE:
                mTvTitle.setText(R.string.signature);
                break;
            case UserConstant.KEY_GENDER:
                mTvTitle.setText(R.string.gender);
                break;
            case UserConstant.KEY_BIRTH:
                mTvTitle.setText(R.string.birthday);
                break;
            case UserConstant.KEY_ALIAS:
                mTvTitle.setText(R.string.alias);
                break;
        }
    }
    ...
    public void onClick(View v) {
        int viewId = v.getId();
        if (viewId == R.id.male_layout) {
            gender = GenderEnum.MALE.getValue();
            genderCheck(gender);
        } else if (viewId == R.id.female_layout) {
            gender = GenderEnum.FEMALE.getValue();
            genderCheck(gender);
        } else if (viewId == R.id.other_layout) {
            gender = GenderEnum.UNKNOWN.getValue();
            genderCheck(gender);
        } else if (viewId == R.id.birth_picker_layout) {
            openTimePicker();
        }
    }
