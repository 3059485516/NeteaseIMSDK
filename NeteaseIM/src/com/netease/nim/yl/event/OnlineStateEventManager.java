package com.netease.nim.yl.event;
...
public class OnlineStateEventManager {
    ...
    private static void registerNetTypeChangeObserver() {
        ...
        NetIMCache.getContext().registerReceiver(receiver, filter);
    }
    ...
    public static void publishOnlineStateEvent(boolean force) {
        ...
        int netState = getNetWorkTypeName(NetIMCache.getContext());
    ...
    private static boolean enableOnlineStateEvent() {
        String packageName = NetIMCache.getContext().getPackageName();
        return enable = (packageName != null && packageName.equals("com.yl.lovestudy"));
    }
}