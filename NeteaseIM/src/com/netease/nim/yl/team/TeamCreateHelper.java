package com.netease.nim.yl.team;
                ...
                new RequestCallback<CreateTeamResult>() {
                    ...
                    public void onSuccess(CreateTeamResult result) {
                        ...
                        if (failedAccounts != null && !failedAccounts.isEmpty()) {
                            ...
                            Toast.makeText(NetIMCache.getContext(), com.netease.nim.uikit.R.string.create_team_success, Toast.LENGTH_SHORT).show();
                        }
                        if (isNeedBack) {
                            Class activity = NetIMCache.getBackActivity();
                            if (activity != null){
                                SessionHelper.startTeamSession(context, result.getTeam().getId(), activity, null); // 进入创建的群
                            }else {
                    ...
                    public void onFailed(int code) {
                        ...
                        if (code == 801) {
                            ...
                            Toast.makeText(NetIMCache.getContext(), tip,
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(NetIMCache.getContext(), com.netease.nim.uikit.R.string.create_team_failed,
                                    Toast.LENGTH_SHORT).show();
                        }
