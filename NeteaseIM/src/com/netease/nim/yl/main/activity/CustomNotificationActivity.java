...
import com.netease.nim.yl.main.helper.CustomNotificationCache;
import com.netease.nim.yl.main.viewholder.CustomNotificationViewHolder;
...
public class CustomNotificationActivity extends UI implements TAdapterDelegate {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (viewId == R.id.send_custom_notification_to_team){
            selectCustomNotificationTarget(true);
        }else if (viewId == R.id.send_custom_notification_to_buddy){
    ...
    private void selectCustomNotificationTarget(boolean team) {
        ...
        option.title = NetIMCache.getContext().getString(R.string.select_custom_notification_target);
        option.multi = false;
    ...
    private void sendCustomNotification(String account, String content) {
        ...
        notification.setFromAccount(NetIMCache.getAccount());
