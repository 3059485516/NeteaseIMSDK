...
import com.netease.nim.yl.contact.activity.UserProfileSettingActivity;
import com.netease.nim.yl.jsbridge.JsBridgeActivity;
import com.netease.nim.yl.main.adapter.SettingsAdapter;
import com.netease.nim.yl.main.model.SettingTemplate;
import com.netease.nim.yl.main.model.SettingType;
...
//                UserPreferences.getNotificationFoldedToggle()));
    ...
    private void onListItemClick(SettingTemplate item) {
        ...
        switch (item.getId()) {
            case TAG_HEAD:
                UserProfileSettingActivity.start(this, NetIMCache.getAccount());
                break;
    ...
    public void onSwitchChange(SettingTemplate item, boolean checkState) {
        switch (item.getId()) {
            ...
            case TAG_LED:
                ...
                StatusBarNotificationConfig demoConfig = NetIMCache.getNotificationConfig();
