...
public class MultiportActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtils.setColor(this, ContextCompat.getColor(this, com.netease.nim.uikit.R.color.theme_color));
        findViews();
        parseIntent();
        updateView();
    }
        ...
        NIMClient.getService(AuthService.class).kickOtherClient(client).setCallback(new RequestCallback<Void>() {
            ...
            public void onSuccess(Void param) {
                ...
                if (client.getClientType() == ClientType.Android) {
                    Handler handler = Handlers.sharedHandler(NetIMCache.getContext());
