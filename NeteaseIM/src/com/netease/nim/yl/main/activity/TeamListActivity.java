...
public class TeamListActivity extends UI implements AdapterView.OnItemClickListener {
    ...
    public static final void start(Context context, int teamItemTypes) {
        start(context, teamItemTypes, null);
    }

    public static final void start(Context context, int teamItemTypes, Uri data) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvTitle.setText(itemType == ItemTypes.TEAMS.ADVANCED_TEAM ? R.string.advanced_team : R.string.normal_team);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (item.getItemType()) {
            case ItemTypes.TEAM:
                SessionHelper.startTeamSession(this, ((ContactItem) item).getContact().getContactId(), null, getIntentData());
                break;
        }
    }
