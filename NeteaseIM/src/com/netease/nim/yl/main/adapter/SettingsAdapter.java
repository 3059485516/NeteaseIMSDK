package com.netease.nim.yl.main.adapter;
...
public class SettingsAdapter extends BaseAdapter {
    ...
    private void updateHeadItem(ViewHolder viewHolder) {
        ...
        viewHolder.headTitleView.setText(UserInfoHelper.getUserDisplayName(NetIMCache.getAccount()));
        viewHolder.headDetailView.setVisibility(View.VISIBLE);
        viewHolder.headDetailView.setText(String.format("帐号:%s", NetIMCache.getAccount()));
        viewHolder.titleView.setVisibility(View.GONE);
        viewHolder.headImageView.loadBuddyAvatar(NetIMCache.getAccount());
