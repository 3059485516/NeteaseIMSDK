...
import com.netease.nim.yl.contact.activity.BlackListActivity;
import com.netease.nim.yl.main.activity.RobotListActivity;
    ...
    final static class FuncItem extends AbsContactItem {
        ...
        static void handle(Context context, AbsContactItem item) {
            if (item == VERIFY) {
                ...
                SessionHelper.startP2PSession(context, NetIMCache.getAccount());
            } else if (item == BLACK_LIST) {
